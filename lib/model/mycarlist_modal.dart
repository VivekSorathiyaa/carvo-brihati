...
MyCarListModal myCarListModalFromJson(String str) =>
    MyCarListModal.fromJson(json.decode(str));
...
class MyCarListModal {
  ...
  factory MyCarListModal.fromJson(Map<String, dynamic> json) => MyCarListModal(
        ...
        mycarlist: List<Mycarlist>.from(
            json["mycarlist"].map((x) => Mycarlist.fromJson(x))),
      );
