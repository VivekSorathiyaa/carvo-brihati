                          ...
                          : InkWell(
                              onTap: () {
                                Get.to(CarDetailsScreen(
                                    id: viewFeatureModal!.featureCar[index].id,
                                    currency: viewFeatureModal!.currency));
                              },
                              child: Container(
                                height: 160,
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    "${viewFeatureModal?.currency}${viewFeatureModal?.featureCar[index].carRentPrice}/${viewFeatureModal?.featureCar[index].priceType == '1' ? 'hr'.tr : 'days'.tr}",
                                                    style: TextStyle(
                                                      fontFamily:
                                                          FontFamily.europaBold,
                                                      color: notifire
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            carTool(
                                                ...
                                                title:
                                                    '${viewFeatureModal?.featureCar[index].totalSeat} ${'Seats'.tr}'),
                                          ],
                                        ),
                                      ),
                                    )
