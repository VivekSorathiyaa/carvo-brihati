...
class AddressUploadScreen extends StatefulWidget {
  const AddressUploadScreen({super.key});

  @override
  State<AddressUploadScreen> createState() => _AddressUploadScreenState();
}

class _AddressUploadScreenState extends State<AddressUploadScreen> {
  ...
  Future addCar(uid, size) async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('${Config.baseUrl}${Config.verifyAddress}'));
    ...
    if (response.statusCode == 200) {
      ...
      FirebaseAnalytics.instance
          .logEvent(name: "address_proof_uploaded", parameters: {
        "userid": uid,
      });
      setState(() {
        _isLoading = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          centerTitle: true,
          title: Text("Upload Proof of Address",
              style: TextStyle(
                  color: Colors.white,
          ...
          child: _isLoading
              ...
              : Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Please upload both sides of your Address ',
                      style: TextStyle(
                        fontSize: 20,
