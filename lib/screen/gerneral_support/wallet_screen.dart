...
class _My_WalletState extends State<My_Wallet> {
  ...
  Future WalletUpdateApi(String uid) async {
    ...
    try {
      var response = await http.post(
          Uri.parse('${Config.baseUrl}${Config.walletUp}'),
          body: jsonEncode(body),
          headers: {
            'Content-Type': 'application/json',
          });
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Top up ${currencies['currency']}${walletController.text}.00',
                    style: TextStyle(
                        fontSize: 30,
                  ...
                  Text(
                    '${currencies['currency']}${walletController.text} has been added to your wallet',
                          ...
                          child: ElevatedButton(
                            style: ButtonStyle(
                                fixedSize:
                                    const WidgetStatePropertyAll(Size(0, 50)),
                                backgroundColor:
                                    WidgetStatePropertyAll(onbordingBlue),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isloading
          ? Center(
              child: CircularProgressIndicator(color: onbordingBlue),
            )
          : GestureDetector(
              onTap: () {
                            ...
                            children: [
                              ListTile(
                                ...
                                title: Transform.translate(
                                    ...
                                    child: Text('TOTAL WALLET BALANCE'.tr,
                                        style: const TextStyle(
                                            color: Colors.grey,
                                            fontSize: 14,
                                            fontFamily:
                                ...
                                subtitle: Transform.translate(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      '${currencies['currency']} ${data?.wallet}',
                                      style: TextStyle(
                                          color: notifire.getwhiteblackcolor,
                                          fontFamily: FontFamily.europaBold,
                                          fontSize: 20),
                                                                    ...
                                                                    onTap: () {
                                                                      ...
                                                                      if (gPayment
                                                                        ...
                                                                        razorPayClass.openCheckout(
                                                                            key:
                                                                                gPayment.paymentdata[0].attributes,
                                                                        ...
                                                                        payStackController
                                                                            ...
                                                                            .then(
                                                                          (value) {
                                                                            Get.to(Paystackweb(url: payStackController.payStackModel!.data.authorizationUrl, skID: sk_key))!.then(
                                                                              (value) {
                                                                                if (verifyPaystack == 1) {
                                                                                  WalletUpdateApi(uId['id']);
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          leading:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Image.network("${Config.imgUrl}${gPayment.paymentdata[index].img}"),
                                                                            ),
                                                                          ),
                                                                          title:
                                                                              Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: notifire.getwhiteblackcolor),
                                                                              maxLines: 2,
                                                                            ),
                                                                          ),
                                                                          subtitle:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: notifire.getwhiteblackcolor),
                                                                              maxLines: 2,
                                                                            ),
                                                                          ),
                                                                          trailing:
                          ...
                          return Transform.translate(
                            ...
                            child: ListTile(
                              leading: data!.walletitem[index].status == 'Debit'
                                  ? Image.asset(Appcontent.minusWallet,
                                      height: 40)
                                  : Image.asset(Appcontent.additionWallet,
                                      height: 40),
                              title: Transform.translate(
                              ...
                              subtitle: Transform.translate(
                                  ...
                                  child: Text(data!.walletitem[index].status,
                                      style: const TextStyle(
                                          ...
                                          fontFamily: FontFamily.europaWoff))),
                              trailing: Text(
                                  '${data!.walletitem[index].status == 'Debit' ? '-' : "+"} ${currencies['currency']}${data!.walletitem[index].amt}',
                                  style: TextStyle(
                                      fontSize: 15,
                                      fontFamily: FontFamily.europaBold,
  ...
  textfield(
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        style: TextStyle(color: notifire.getwhiteblackcolor, fontSize: 18),
