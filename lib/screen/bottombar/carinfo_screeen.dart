...
class _CarInfoScreenState extends State<CarInfoScreen> {
  ...
  save() async {
    ...
    user == "ADMIN"
        ? data1 = preferences.getString('AdminLogin')!
        : data = preferences.getString('UserLogin')!;
    user == "ADMIN"
        ? admin = data1.toString().isNotEmpty ? jsonDecode(data1) : ""
        : name = data.toString().isNotEmpty ? jsonDecode(data) : "";
                        ...
                        return InkWell(
                          onTap: () {
                            if (index == 0) {
                              ...
                              Get.to(MyBookScreen(
                                  uid: uid == "0" ? "0" : name['id'],
                                  dollarSign: dashboardModal?.currency));
                            } else if (index == 2) {
                              Get.to(payout_screen(
                                  earning: double.parse(dashboardModal!
                                      .reportData[3].reportData
                                      .toString()),
                                  minimum: dashboardModal!
                                      .reportData[5].reportData));
                            } else if (index == 3) {
                                                              ...
                                                              Container(
                                                                ...
                                                                child: ListTile(
                                                                  ...
                                                                  trailing: SizedBox(
                                                                      ...
                                                                      child: Image
                                                                          .network(
                                                                              '${Config.imgUrl}${dashboardModal!.reportData[index].url}')),
                                                                ),
                                                              ),
                                                              Padding(
                                                                padding:
                                                                    const EdgeInsets
                                                                        ...
                                                                        top:
                                                                            13),
                                                                child: Text(
                                                                    '${index == 0 ? '' : index == 1 ? '' : index == 2 ? '' : dashboardModal?.currency}${index == 3 ? double.parse(dashboardModal!.reportData[index].reportData.toString()).toStringAsFixed(2) : dashboardModal!.reportData[index].reportData}',
                                                                    style: TextStyle(
                                                                        color: notifire
                                                                            .getwhiteblackcolor,
                                                                        fontSize:
