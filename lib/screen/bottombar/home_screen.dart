...
class _HomeScreenState extends State<HomeScreen> {
  ...
  getCurrentLatAndLongs() async {
    print("permission asking");
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          bool isVerified = verifyStatus!.featureCar.first.idStatus == "3" &&
                  verifyStatus!.featureCar.first.passportStatus == "3" &&
                  verifyStatus!.featureCar.first.addressStatus == "3" &&
                  verifyStatus!.featureCar.first.photoStatus == "3" &&
                  verifyStatus!.featureCar.first.drivingStatus == "3"
              ? true
              : false;
  ...
  Future<void> getStatus(bool value) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setBool('isVerified', value);
    print(value);
  }
          ...
          leading: GestureDetector(
            ...
            child: Container(
              ...
              child: Image.asset(Appcontent.location,
                  height: 25, width: 25, color: notifire.getwhiteblackcolor),
          ...
          actions: [
            GestureDetector(
              ...
              child: Container(
                ...
                width: 40,
                padding: EdgeInsets.all(8),
                child: Image.asset(Appcontent.notification1,
                    height: 25, width: 25, color: notifire.getwhiteblackcolor),
                margin: EdgeInsets.all(8),
                decoration: BoxDecoration(
                  border: Border.all(color: notifire.getborderColor),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                                ...
                                                return Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                      ...
                                                      image: DecorationImage(
                                                          image: NetworkImage(
                                                              "${Config.imgUrl}${banner.banner[index].img}"),
                                                          fit:
                                                              BoxFit.fitWidth)),
                                                );
                                              },
                                          ...
                                          itemBuilder: (context, index) {
                                            return InkWell(
                                              onTap: () {
                                                ...
                                                Get.to(TypeWiseScreen(
                                                    typeId: banner
                                                        .cartypelist[index].id,
                                                    typeCar: banner
                                                        .cartypelist[index]
                                                        .title));
                                              },
                                              child: Container(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Image.network(
                                                      "${Config.imgUrl}${banner.cartypelist[index].img}",
                                                      height: 30,
                                                    ),
                                                    SizedBox(width: 8),
                                                    Text(
                                      ...
                                      SizedBox(
                                        height: 330,
                                        width: Get.size.width,
                                        child: banner.featureCar.isEmpty
                                            ? ematyCar(
                                                title: 'Featured Cars'.tr,
                                                colors:
                                                    notifire.getwhiteblackcolor)
                                            : ListView.builder(
                                                itemCount:
                                                    banner.featureCar.length,
                                                scrollDirection:
                                                    Axis.horizontal,
                                                physics:
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: ClipRRect(
                                                        ...
                                                        child: Stack(
                                                          ...
                                                          children: [
                                                            Image.network(
                                                                "${Config.imgUrl}${banner.featureCar[index].carImg}",
                                                                fit: BoxFit
                                                                    .cover),
                                                            Container(
                                                              decoration:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                            banner.featureCar[index].carRating,
                                                                            style: TextStyle(fontFamily: FontFamily.europaWoff, color: Colors.white)),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                ),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            carTool1(
                                                                                ...
                                                                                title: banner.featureCar[index].carGear == '1' ? 'Automatic'.tr : 'Manual'.tr),
                                                                            carTool1(
                                                                                image: Appcontent.petrol,
                                                                                title: banner.featureCar[index].fuelType == '0'
                                                                                    ? 'Petrol'.tr
                                                                                    : banner.featureCar[index].fuelType == '1'
                                                                                        ? 'Diesel'.tr
                                                                                        : banner.featureCar[index].fuelType == '2'
                                                                                            ? 'Electric'.tr
                                                                                            : banner.featureCar[index].fuelType == '3'
                                                                                                ? 'CNG'.tr
                                                                                                : 'Petrol & CNG'.tr),
                                                                            carTool1(
                                                                                image: Appcontent.seat,
                                                                                number: banner.featureCar[index].totalSeat,
                                                                                text: 'Seats'.tr),
                                                                          ],
                                                                        ),
                                                                      ),
                                            ...
                                            return InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Image.network(
                                                        "${Config.imgUrl}${banner.carbrandlist[index].img}",
                                                        height: 40),
                                                    SizedBox(height: 10),
                                                    Text(
                                                      banner.carbrandlist[index]
                                                          .title,
                                                      style: TextStyle(
                                                        fontFamily: FontFamily
                                                            .europaBold,
                                      ...
                                      banner.recommendCar.isEmpty
                                          ? Padding(
                                              ...
                                              child: ematyCar(
                                                  title:
                                                      'Car recommendation'.tr,
                                                  colors: notifire
                                                      .getwhiteblackcolor),
                                            )
                                          : ListView.builder(
                                              itemCount:
                                                  banner.recommendCar.length,
                                              shrinkWrap: true,
                                              physics:
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            borderRadius:
                                                                                BorderRadius.circular(20),
                                                                            image:
                                                                                DecorationImage(image: NetworkImage('${Config.imgUrl}${banner.recommendCar[index2].carImg[0]}'), fit: BoxFit.cover),
                                                                          ),
                                                                        ),
                                                                        Container(
                                                                          decoration:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          filter: ImageFilter.blur(
                                                                              ...
                                                                              sigmaY: 10),
                                                                          child: Text(
                                                                              banner.recommendCar[index2].carTitle,
                                                                              style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: Colors.white, fontSize: 12, fontFamily: FontFamily.europaBold)),
                                                                        ),
                                                                      ),
                                                                    ),
                                                                    ClipRRect(
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                          ...
                                                                          style: TextStyle(
                                                                              fontFamily: FontFamily.europaBold,
                                                                              color: Colors.white)),
                                                                      banner.recommendCar[index2].carImg.length ==
                                                                              1
                                                                          ? SizedBox()
                                                                          : Row(
                                                                              mainAxisAlignment: MainAxisAlignment.center,
                                                                              children: banner.recommendCar[index2].carImg.asMap().entries.map((e) {
                                                                                return InkWell(
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: temp[index2] == e.key ? onbordingBlue : Colors.grey),
                                                                                  ),
                                                                                );
                                                                              }).toList(),
                                                                            ),
                                                                      Text(
                                                                          '${banner.currency}${banner.recommendCar[index2].carRentPrice} /${banner.recommendCar[index2].priceType == '1' ? 'hr'.tr : 'days'.tr}',
                                                                          style: TextStyle(
                                                                              fontFamily: FontFamily.europaBold,
                                                                              color: Colors.white)),
                                                                    ],
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                carTool(
                                                                    image: Appcontent
                                                                        .gearbox,
                                                                    title: banner.recommendCar[index2].engineHp ==
                                                                            '1'
                                                                        ? 'Automatic'
                                                                            .tr
                                                                        : 'Manual'
                                                                ...
                                                                carTool(
                                                                    image: Appcontent
                                                                        .petrol,
                                                                    title: banner.recommendCar[index2].fuelType ==
                                                                            '0'
                                                                        ? 'Petrol'
                                                                            .tr
                                                                        : banner.recommendCar[index2].fuelType ==
                                                                                '1'
                                                                            ? 'Diesel'.tr
                                                                            : banner.recommendCar[index2].fuelType == '2'
                                                                                ? 'Electric'.tr
                                                                                : banner.recommendCar[index2].fuelType == '3'
                                                                                    ? 'CNG'.tr
                                                                                    : 'Petrol & CNG'.tr),
                                                                carTool(
                                                                    image:
          ...
          children: [
            Container(
              ...
              child: Shimmer.fromColors(
                baseColor:
                    notifire.isDark ? Colors.black45 : Colors.grey.shade100,
                highlightColor:
                    notifire.isDark ? Color(0xFF475569) : Color(0xFFeaeff4),
                child: Container(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(16),
                          border:
                              Border.all(color: notifire.getblackwhitecolor)),
                    );
                  },
                ),
              ),
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: Shimmer.fromColors(
                      baseColor: notifire.isDark
                          ? Colors.black45
                          : Colors.grey.shade100,
                      highlightColor: notifire.isDark
                          ? Color(0xFF475569)
                          : Color(0xFFeaeff4),
                      enabled: true,
                      child: Column(
