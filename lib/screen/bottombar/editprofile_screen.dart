...
class _EditScreenState extends State<EditScreen> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        FirebaseAnalytics.instance
            .logEvent(name: "account_edited", parameters: {
          'uid': uid,
        });
  ...
  Future proImage(uid, image) async {
    ...
    try {
      var response = await http.post(
          Uri.parse(Config.baseUrl + Config.proImage),
          body: jsonEncode(body),
          headers: {
            'Content-Type': 'application/json',
          });
      if (response.statusCode == 200) {
        ...
        preferences.setString(
            'UserLogin', jsonEncode(proImageModal!.userLogin));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: GestButton(
        ...
        style: TextStyle(
            color: WhiteColor, fontFamily: FontFamily.europaBold, fontSize: 15),
        onclick: () {
          if (nameController.text.isNotEmpty &&
              emailController.text.isNotEmpty &&
              passwordController.text.isNotEmpty) {
            eprofile(UId, nameController.text, emailController.text,
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Padding(
                        ...
                        child: Image.asset(Appcontent.user,
                            height: 24, width: 24, color: greyScale1),
                      ),
                    ),
                    validator: (value) {
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Padding(
                        padding: const EdgeInsets.all(10),
                        child: Image.asset(Appcontent.mail,
                            height: 24, width: 24, color: greyScale1),
                      ),
                    ),
                    validator: (value) {
