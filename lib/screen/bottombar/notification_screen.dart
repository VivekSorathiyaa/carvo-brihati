...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Future notification(uid) async {
    ...
    try {
      var response = await http.post(
          Uri.parse(Config.baseUrl + Config.notificationList),
  ...
  validate() async {
    ...
    var id = widget.uid == "0"
        ? "0"
        : jsonDecode(preferences.getString('UserLogin')!);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: loading
            ? loader()
            : notificatonListModal!.notificationData.isEmpty
                ? ematy(
                              ...
                              child: ListTile(
                                ...
                                leading: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                          color: greyScale.withOpacity(0.40))),
                                  child: Padding(
