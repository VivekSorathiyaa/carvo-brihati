...
class _FavoriteScreenState extends State<FavoriteScreen> {
  ...
  Future favCar(uid, cityId) async {
    ...
    try {
      print(uid);
      var response = await http.post(Uri.parse(Config.baseUrl + Config.uFavCar),
  ...
  Future favorite(uid, carId) async {
    ...
    try {
      var response = await http.post(Uri.parse(Config.baseUrl + Config.uFav),
          body: jsonEncode(body),
          headers: {
            'Content-Type': 'application/json',
          });
          ...
          return loaders
              ...
              : Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "${favo?.featureCar.length} ${'cars'.tr}".tr,
                        style: TextStyle(
                          fontFamily: FontFamily.europaBold,
                          fontSize: 15,
                          color: notifire.getwhiteblackcolor,
                      ...
                      Expanded(
                        child: favo!.featureCar.isNotEmpty
                            ? ListView.builder(
                                                          ...
                                                          Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                                ...
                                                                image: DecorationImage(
                                                                    image: NetworkImage(
                                                                        '${Config.imgUrl}${favo?.featureCar[index].carImg.toString().split("\$;").elementAt(0)}'),
                                                                    fit: BoxFit
                                                                        .cover)),
                                                          ),
                                                          SizedBox(
                                                      ...
                                                      children: [
                                                        ...
                                                        carTool(
                                                            image: Appcontent
                                                                .petrol,
                                                            title:
                                                                '${favo!.featureCar[index].fuelType == '0' ? "Petrol".tr : favo!.featureCar[index].fuelType == '1' ? "Diesel".tr : favo!.featureCar[index].fuelType == '2' ? 'Electric'.tr : favo!.featureCar[index].fuelType == '3' ? 'CNG'.tr : 'Petrol & CNG'.tr} '),
                                                        carTool(
                                                            image:
                                                                Appcontent.seat,
                                                            number: favo!
                            ...
                            : Column(
                                ...
                                children: [
                                  Image.asset(Appcontent.ematyState,
                                      height: 96),
                                  SizedBox(height: 20),
                                  Text('No favorite yet!'.tr,
                                      style: TextStyle(
                                          fontSize: 24,
                                          fontFamily: FontFamily.europaBold,
                                          color: notifire.getwhiteblackcolor)),
                                  SizedBox(height: 10),
                                  Text(
                                      'It can be used to express that something is not someone Favorites'
                                          .tr,
                                      style: TextStyle(
                                          fontSize: 16,
