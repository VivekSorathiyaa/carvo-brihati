...
class _ListCarScreenState extends State<ListCarScreen> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (int i = 0; i < myCarListModal!.mycarlist.length; i++) {
          print(myCarListModal!.mycarlist.length);
          print(temp);
          temp.add(0);
        }
 ...
 final CarouselSliderController carouselController = CarouselSliderController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: Text('My Car List'.tr,
            style: const TextStyle(
                fontFamily: FontFamily.europaBold, color: Colors.white)),
        actions: [
          Padding(
            ...
            child: ElevatedButton(
                ...
                onPressed: () {
                  ...
                  selectedValue = null;
                  isApproveValue = null;
                  rejectCommentValue = null;
                  setState(() {});
                  Get.to(
                      AddCarScreen(uid: widget.uid == "0" ? "0" : widget.uid));
                },
      ...
      body: isLoading
          ? loader()
          : myCarListModal!.mycarlist.isEmpty
              ? ematyCar(
                  title: 'My Car List'.tr, colors: notifire.getwhiteblackcolor)
              : myCarListModal!.mycarlist.isEmpty
                  ? ematyCar(
                      title: 'My Car List'.tr,
                      colors: notifire.getwhiteblackcolor)
                  : SingleChildScrollView(
                      child: Column(
                        children: [
                          ListTile(
                            leading: Text('List Of Car'.tr,
                                style: TextStyle(
                          ...
                          ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                image = myCarListModal!.mycarlist[index].carImg
                                    .toString()
                                    .split("\$;");
                                return Container(
                                  // height: 250,
                                                      ...
                                                      Container(
                                                        ...
                                                        decoration:
                                                          ...
                                                          image: DecorationImage(
                                                              image: NetworkImage(
                                                                  '${Config.imgUrl}${myCarListModal!.mycarlist[index].carImg}'),
                                                              fit:
                                                                  BoxFit.cover),
                                                        ),
                                                      ),
                                                      ...
                                                      InkWell(
                                                        onTap: () {
                                                            ...
                                                            minimum:
                                                                myCarListModal!
                                                                    .mycarlist[
                                                                        index]
                                                                    .minHrs,
                                                            unavailableDates: (myCarListModal!
                                                                    .mycarlist[
                                                                        index]
                                                                    .unavailableDates!
                                                                    .replaceAll(
                                                          ...
                                                          Get.to(AddCarScreen(
                                                                  ...
                                                                  uid: widget
                                                                      .uid,
                                                                  recordId: myCarListModal
                                                                      ?.mycarlist[
                                                                          index]
                                                                      .id,
                                                                  title: myCarListModal
                                                                      ?.mycarlist[
                                                                          index]
                                                                      .carTitle))!
                                                              .then((value) {
  ...
  List<DateTime?> parseUnavailableDates(String input) {
  // Split the string to isolate the JSON value
  String jsonString = input.split(":")[1].trim();

  // Remove surrounding quotes
  jsonString = jsonString.substring(1, jsonString.length - 1);

  // Decode the JSON array to a list of strings
  List<dynamic> dateStrings = jsonDecode(jsonString);

  // Convert to List<DateTime?>
  return dateStrings.map((date) => DateTime.tryParse(date)).toList();
}
