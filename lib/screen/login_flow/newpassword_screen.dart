...
class NewPasswordScreen extends StatefulWidget {
  ...
  const NewPasswordScreen(
      {super.key, required this.conutry, required this.mobile});
  ...
  Future forgotPassword(password) async {
    ...
    try {
      var response = await http.post(
          Uri.parse(Config.baseUrl + Config.forgotPassword),
                        ...
                        return SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Image.asset(Appcontent.passwordch,
                                  height: 96, width: 96),
                              Text('Password changed!'.tr,
                                  style: TextStyle(
                                      fontSize: 24,
                                      fontFamily: FontFamily.europaBold,
                              ...
                              Column(
                                children: [
                                  Text(
                                    'Awesome. You’re successfully'.tr,
                                    style: TextStyle(
                                        fontSize: 16,
  ...
  passwordRow({
    ...
    return Row(
      children: [
        ...
        Text(title ?? "",
            style:
                TextStyle(color: textColor, fontFamily: FontFamily.europaWoff)),
      ],
    );
  }
}
