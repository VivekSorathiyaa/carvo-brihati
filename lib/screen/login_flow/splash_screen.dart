...
import 'package:carlink/screen/login_flow/disclamar_screen.dart';
    ...
    getDataFromLocal().then((value) async {
      ...
      if(user == "ADMIN"){
        ...
        if (isLogin) {
          ...
          Timer(const Duration(seconds: 3), () {
            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => const DisclamarScreen()), (route) => false);
          });
        }
      }
          ...
          child: Column(
            ...
            children: [
              ClipOval(
                ...
                child: Image.asset(Appcontent.appLogo,height: 165,)),
              const SizedBox(height: 15),
              Text('Carvo Carshare',style: TextStyle(fontFamily: FontFamily.europaBold, fontSize: 39, color: notifire.getwhiteblackcolor)),
            ],
          ),
        ));
  }
