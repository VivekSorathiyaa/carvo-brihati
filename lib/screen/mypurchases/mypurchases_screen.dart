                ...
                child: Column(
                  children: [
                    TabBar(
                        ...
                        indicatorWeight: 3,
                        labelStyle:
                            const TextStyle(fontFamily: FontFamily.europaBold),
                        tabs: [
                          Tab(text: 'Booked'.tr),
                          Tab(text: 'History'.tr),
                        ]),
                                                        ...
                                                        carTools(
                                                            ...
                                                            title: bookHistory!
                                                                ...
                                                                : bookHistory!
                                                                    ...
                                                                    ? 'Diesel'
                                                                        .tr
                                                                    : bookHistory!.bookHistory[index2].fuelType ==
                                                                            '2'
                                                                        ? 'Electric'
                                                                            .tr
                                                                        : bookHistory!.bookHistory[index2].fuelType ==
                                                        ...
                                                        carTools(
                                                            ...
                                                            title: bookHistory1!
                                                                ...
                                                                : bookHistory1!
                                                                    ...
                                                                    ? 'Diesel'
                                                                        .tr
                                                                    : bookHistory1!.bookHistory[index2].fuelType ==
                                                                            '2'
                                                                        ? 'Electric'
                                                                            .tr
                                                                        : bookHistory1!.bookHistory[index2].fuelType ==
...
carTools(
  ...
  return Row(
    children: [
      ...
      Text(title ?? '',
          style: TextStyle(
              fontFamily: FontFamily.europaWoff, color: color, fontSize: 13)),
      RichText(
          text: TextSpan(
        children: [
          TextSpan(
