...
import 'package:intl/intl.dart'; /*makes sure commas are on numbers*/
...
class _CarDetailsScreenState extends State<CarDetailsScreen> {
  ...
  Future carInfo(uid) async {
    ...
    try {
      var response = await http.post(Uri.parse(Config.baseUrl + Config.cInfo),
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          _onAddMarkerButtonPressed(double.parse(info.carinfo.pickLat),
              double.parse(info.carinfo.pickLng));
          getLocation();
  ...
  Future rateList(carId) async {
    ...
    try {
      var response = await http.post(
          Uri.parse(Config.baseUrl + Config.rateList),
          body: jsonEncode(body),
          headers: {
            'Content-Type': 'application/json',
          });
  ...
  Future getLocation() async {
    ...
    distance = Geolocator.distanceBetween(position.latitude, position.longitude,
        double.parse(info.carinfo.pickLat), double.parse(info.carinfo.pickLng));
                      ...
                      children: [
                        ...
                        RichText(
                          ...
                          children: [
                            TextSpan(
                                text:
                                    '${widget.currency}${info.carinfo.carRentPrice} ',
                                style: TextStyle(
                                    color: onbordingBlue,
                            ...
                            TextSpan(
                                text:
                                    '/${info.carinfo.priceType == '1' ? "hr".tr : "days".tr}',
                                style: TextStyle(
                                    color: Colors.grey,
                                    fontFamily: FontFamily.europaWoff,
                                    fontSize: 15)),
                      ...
                      onclick: () {
                        ...
                        Get.to(BuyCarDetailsScreen(
                            ...
                            price:
                                '${widget.currency} ${info.carinfo.carRentPrice}',
                            withDriver:
                                '${widget.currency}${info.carinfo.carRentPriceDriver}',
                            ptype:
                                info.carinfo.priceType == '1' ? "hr" : "days",
                            minHrs: info.carinfo.minHrs));
                      },
                    ),
                  ],
                ),
            ...
            : CollapsingAppBarPage(
                ...
                bodyCreator: (context) {
                  return Column(
                    children: [
                      ListTile(
                        title: Text(info.carinfo.carTitle,
                            style: TextStyle(
                                fontFamily: FontFamily.europaBold,
                                fontSize: 18,
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                             carType(image: Appcontent.clock, title: "Minimum Days", subtitle: info.carinfo.minHrs),
                            carType(
                                image: Appcontent.gearbox,
                                title: 'Transmission type'.tr,
                                subtitle: info.carinfo.carGear == '1'
                                    ? 'Automatic'.tr
                                    : 'Manual'.tr),
                            carType(
                                image: Appcontent.petrol,
                                title: 'Fuel type'.tr,
                                subtitle: info.carinfo.fuelType == '0'
                                    ? 'Petrol'.tr
                                    : info.carinfo.fuelType == '1'
                                        ? 'Diesel'.tr
                                        : info.carinfo.fuelType == '2'
                                            ? 'Electric'.tr
                                            : info.carinfo.fuelType == '3'
                                                ? 'CNG'.tr
                                                : 'Petrol & CNG'.tr),
                            carType(
                                ...
                                title: 'Seats'.tr,
                                subtitle:
                                    '${info.carinfo.totalSeat} ${'Seats'.tr}'
                                        .tr),
                          ],
                        ),
                      ),
                      ...
                      TabBar(
                        ...
                        labelStyle: TextStyle(
                            fontFamily: FontFamily.europaBold, fontSize: 15),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  carTypeList(
                      title: 'Car Number'.tr, brand: info.carinfo.carNumber),
                  SizedBox(height: 15),
                  carTypeList(
                      title: 'Total KM'.tr, brand: info.carinfo.totalKm),
                  SizedBox(height: 15),
                  carTypeList(
                      title: 'Car Brand'.tr, brand: info.carinfo.carBrandTitle),
                  SizedBox(height: 15),
                  carTypeList(
                      title: 'Car Type'.tr, brand: info.carinfo.carTypeTitle),
                  SizedBox(height: 15),
                  carTypeList(
                      title: 'Car AC'.tr,
                      brand: info.carinfo.carAc == '1' ? 'AC' : 'Non-AC'),
                ],
              ),
            ),
            Row(
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: Text(info.carinfo.pickAddress,
                        style: TextStyle(
                            fontFamily: FontFamily.europaBold,
                            color: notifire.getwhiteblackcolor,
                            fontSize: 14))),
              ...
              child: ClipRRect(
                ...
                child: GoogleMap(
                  ...
                  initialCameraPosition: CameraPosition(
                      target: LatLng(double.parse(info.carinfo.pickLat),
                          double.parse(info.carinfo.pickLng)),
                      zoom: 13),
          ...
          children: [
            ...
            Transform.translate(
              ...
              child: ListView.separated(
                  ...
                  itemCount:
                      info.carinfo.facilityImg.toString().split(",").length,
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Image.network(
                                  "${Config.imgUrl}${info.carinfo.facilityImg.toString().split(",").elementAt(index)}"),
                            ),
                            SizedBox(width: 15),
                            Text(
                              info.carinfo.carFacility
                                  .toString()
                                  .split(",")
                                  .elementAt(index),
                              style: TextStyle(
                ...
                ? Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 10),
                        Text(
                            'It can be used to express that something is not someone Gallery.'
                                .tr,
                            style: TextStyle(
                                fontSize: 16,
                                fontFamily: FontFamily.europaWoff,
  ...
  reviewsWidget() {
    return Padding(
      ...
      child: reviewModal!.reviewdata.isEmpty
          ? SingleChildScrollView(
              child: Padding(
                padding: const EdgeInsets.symmetric(vertical: 10),
                child: review(
                    title: 'Review'.tr, color: notifire.getwhiteblackcolor),
              ),
            )
          : SingleChildScrollView(
              child: Column(
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  reviewModal!.reviewdata[index].userImg.isEmpty
                                      ? CircleAvatar(
                                          backgroundImage:
                                      ...
                                      : CircleAvatar(
                                          backgroundImage: NetworkImage(
                                              '${Config.imgUrl}${reviewModal?.reviewdata[index].userImg}')),
                                  SizedBox(
                                    width: 10,
                                  ),
                                  Column(
                                  ...
                                  SizedBox(width: 6),
                                  Text(reviewModal!.reviewdata[index].userRate,
                                      style: TextStyle(
                                          fontFamily: FontFamily.europaBold,
                                          fontSize: 15,
                                          fontWeight: FontWeight.w700,
                              ...
                              SizedBox(height: 10),
                              Text(reviewModal!.reviewdata[index].userDesc,
                                  style: TextStyle(
                                      fontFamily: FontFamily.europaWoff,
                                      fontSize: 12,
                                      fontWeight: FontWeight.w500,
