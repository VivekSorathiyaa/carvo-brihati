class Config {
  static String baseUrl = "https://admin.jarental.com/api/";
  // static String baseUrl = "https://app.silverwoodrental.com/api/";
  static String imgUrl = "https://admin.jarental.com/"; //to changed from https://carlink.cscodetech.cloud/"
  // static String imgUrl = "https://app.silverwoodrental.com/"; 
  static String pGateway = "https://admin.jarental.com/";
  ...
  static String unavailableRange = "unavailable_range.php";
  ...
  //user verify
  static String verifyAddress = "verify_address.php";
  static String verifyDriving = "verify_driving.php";
  static String verifyid = "verify_id.php";
  static String verifyLivePhoto = "verify_live_photo.php";
  static String verifyPassport = "verify_passport.php";
  static String verifyStatus = "verify_status.php";
}
